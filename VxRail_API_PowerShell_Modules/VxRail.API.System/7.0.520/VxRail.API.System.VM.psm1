...
<#
.Synopsis
Get all system VMs installed in the VxRail cluster.
...
.Notes 
You can run this cmdlet to get all system VMs installed in the VxRail cluster.

.Example
C:\PS>Get-SystemVirtualMachines -Server <vxm ip or FQDN> -Username <username> -Password <password>

Retrieves all system VMs installed in the VxRail cluster.
#>
function Get-SystemVirtualMachines {
    param(
    ...
    $uri = "/rest/vxm/v1/cluster/system-virtual-machines"
    try{ 
