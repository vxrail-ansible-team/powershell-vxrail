...
.Parameter Types
The types of the log to collect. Include: vxm, vcenter, esxi, idrac, ptagent, connectivity. 
Connectivity is supported starting from VxRail 8.0.330.
...
function New-SupportLogs {
    ...
    param (
        ...
        # The types of the log to collect.Include: vxm, vcenter, esxi, idrac, ptagent, connectivity. Connectivity is supported starting from VxRail 8.0.330.
        [parameter(Mandatory=$true, HelpMessage="Supported log bundle types: 'esxi','vcenter','idrac','ptagent','vxm','connectivity'")]
        [ValidateSet('esxi','vcenter','idrac','ptagent','vxm','connectivity')]
        [String[]] $Types
    )
