...
.Parameter Version
Optional,API version. Supported Version v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v12,v13,v14,v15,v16 default version is v1.
...
function Get-Hosts {
    ...
    # check Version
    if(("v1","v2","v3","v4","v5","v6","v7","v8","v9","v10","v12","v13","v14","v15","v16") -notcontains $Version.ToLower()) {
